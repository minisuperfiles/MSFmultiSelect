...
class MSFmultiSelect {
  ...
  toggleSelectAllBtn(allSelected = null) {
    ...
    var showList,
      showCheckedList,
      selectAllInput = this.list.querySelector(
        'li.ignore input[type="checkbox"]'
      );
    if (allSelected == null) {
      showList = this.list.querySelectorAll(
        'label:not([class*=hidden]):not([class*=ignore]) input[type="checkbox"][value]'
      );
      showCheckedList = this.list.querySelectorAll(
        'label:not([class*=hidden]):not([class*=ignore]) input[type="checkbox"][value]:checked'
      );
